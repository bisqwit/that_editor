...
REM d:\editor\bin\bcc -k- -S -P -ff -Ff -x- -RT- -w -w-sig -w-inl -d -a -O2 -Os -OW -f287 -4 -mc -I..\include kbhit.cc
...
REM d:\editor\bin\tasm /D__COMPACT__ /D__CDECL__ /r /ml /m9 kbhit.asm,kbhit.obj
...
REM d:\editor\bin\tlink /3 /m /c ..\lib\c0c.obj main.obj mario.obj vga.obj cpu.obj kbhit.obj,e.exe,,..\lib\cc.lib ..\lib\mathc.lib ..\lib\fp87.lib
